    ...
    <Fragment>
      <div className="navbar">
        <div className="navbar-content">
          ...
          <div className="navbar-user" onClick={() => setClassName('settings-nav show')}>
      ...
      <div className={className}>
        <div className="nav-button-area">
          <div className="nav-button" onClick={() => setClassName('settings-nav')}>
      ...
      <div className="entity-nav">
        <Link to="/tenders" className="btn btn-small btn-round btn-primary">
          Тендеры
        </Link>
